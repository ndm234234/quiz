...
[
  ...
  },
  {
    ...
    answers: [2],
    "info" : "Школа №1564 имени дважды Героя Советского Союза А. П. Белобородова. Афана́сий Павла́нтьевич Белоборо́дов (18 (31) января 1903, деревня Акинино-Баклаши Иркутского округа Иркутской губернии — 1 сентября 1990, Москва) — советский военачальник, генерал армии (1963). Дважды Герой Советского Союза (1944, 1945). Член ЦК КПСС (1966—1971).",
    "info_img": "Beloborodov_AP.jpg",
    score: 30,
...
init: (commandNames) => {
  ...
  for (let i = 0; i < quiz.data.items.length; i++) {
    ...
    query = { query : quiz.data.items[i].question, 
              ...
              info_img : quiz.data.items[i].info_img
            };
